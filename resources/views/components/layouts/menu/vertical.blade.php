...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->is('categories') ? 'active' : '' }}">
      <a class="menu-link" href="{{ route('categories') }}" wire:navigate>{{ __('Catégories') }}</a>
    </li>
    <!-- Products -->
    <li class="menu-item {{ request()->is('products') ? 'active' : '' }}">
      <a class="menu-link" href="{{ route('products') }}" wire:navigate>{{ __('Produits') }}</a>
    </li>
    <!-- Purchases -->
    <li class="menu-item {{ request()->is('purchases') ? 'active' : '' }}">
      <a class="menu-link" href="{{ route('purchases') }}" wire:navigate>{{ __('Achats') }}</a>
    </li>
    <!-- Sales -->
    <li class="menu-item {{ request()->is('sales') ? 'active' : '' }}">
      <a class="menu-link" href="{{ route('sales') }}" wire:navigate>{{ __('Ventes') }}</a>
    </li>
